...
public abstract class Layer
{
    ...
    public int getINPUT_DEPTH() { return INPUT_DEPTH; }
    public int getINPUT_WIDTH() { return INPUT_WIDTH; }
    public int getINPUT_HEIGHT() { return INPUT_HEIGHT; }
    public int getOUTPUT_DEPTH() { return OUTPUT_DEPTH; }
    public int getOUTPUT_WIDTH() { return OUTPUT_WIDTH; }
    public int getOUTPUT_HEIGHT() { return OUTPUT_HEIGHT; }
    public Layer getPrev_layer() { return prev_layer; }
    public Layer getNext_layer() { return next_layer; }
    public double[][][] getOutput_values() { return output_values; }
    ...
    public void printOutput() { printArray(this.output_values); }
    public void printErrorValues() { printArray(this.getOutput_error_values()); }
